...
This function takes the D x N matrix of N data points and writes every
...
Opt: type of optimization, {'L1Perfect','L1Noise','Lasso','L1ED'}
...
Avoid calls to functions deprecated since cvxpy 1.1.
